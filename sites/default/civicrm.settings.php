...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:root@localhost/chennaismiles_drupal?new_link=true' );
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://root:root@localhost/chennaismiles_civicrm?new_link=true' );
}
...
$civicrm_root = '/Users/johanna/htdocs/chennaismiles/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/Users/johanna/htdocs/chennaismiles/sites/default/files/civicrm/templates_c/' );
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'd93ce11de323cf16ccae19e777ce4813' );
}
...
// define( 'CIVICRM_MAIL_LOG', '/Applications/MAMP/htdocs/chennaismiles/sites/default/files/civicrm/templates_c//mail.log' );
// }
